...
- `templates/AzureBlue/unified.cshtml`
- `templates/AzureBlue/selfAsserted.cshtml`
- `templates/AzureBlue/exception.cshtml`
...
Upload the files to a publicly accessible host and configure the user flow's **Page layout** / **Custom page URI** settings to reference the appropriate file.
